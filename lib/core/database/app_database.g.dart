...
class $BudgetsTable extends Budgets with TableInfo<$BudgetsTable, BudgetRow> {
  ...
  scopeType = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('SINGLE_CATEGORY'),
  ).withConverter<BudgetScopeType>($BudgetsTable.$converterscopeType);
  static const VerificationMeta _amountMinorMeta = const VerificationMeta(
    'amountMinor',
  );
  @override
  ...
  BudgetRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return BudgetRow(
      ...
      scopeType: $BudgetsTable.$converterscopeType.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
  ...
  static TypeConverter<BudgetScopeType, String> $converterscopeType =
...
class BudgetRow extends DataClass implements Insertable<BudgetRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    }
    {
      map['scope_type'] = Variable<String>(
        $BudgetsTable.$converterscopeType.toSql(scopeType),
      );
    }
    map['amount_minor'] = Variable<int>(amountMinor);
    map['currency'] = Variable<String>(currency);
  ...
  factory BudgetRow.fromJson(
    ...
    return BudgetRow(
      id: serializer.fromJson<String>(json['id']),
      categoryId: serializer.fromJson<String?>(json['categoryId']),
      scopeType: serializer.fromJson<BudgetScopeType>(json['scopeType']),
      amountMinor: serializer.fromJson<int>(json['amountMinor']),
      currency: serializer.fromJson<String>(json['currency']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<String>(id),
      'categoryId': serializer.toJson<String?>(categoryId),
      'scopeType': serializer.toJson<BudgetScopeType>(scopeType),
      'amountMinor': serializer.toJson<int>(amountMinor),
      'currency': serializer.toJson<String>(currency),
...
class BudgetsCompanion extends UpdateCompanion<BudgetRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (scopeType.present) {
      map['scope_type'] = Variable<String>(
        $BudgetsTable.$converterscopeType.toSql(scopeType.value),
      );
    }
    if (amountMinor.present) {
      map['amount_minor'] = Variable<int>(amountMinor.value);
...
class $RecurringTransactionsTable extends RecurringTransactions
  ...
  late final GeneratedColumnWithTypeConverter<RecurringStatus, String> status =
      GeneratedColumn<String>(
        ...
        $RecurringTransactionsTable.$converterstatus,
      );
  static const VerificationMeta _createdAtMeta = const VerificationMeta(
    'createdAt',
  );
  ...
  RecurringTransactionRow map(
    ...
    return RecurringTransactionRow(
      ...
      status: $RecurringTransactionsTable.$converterstatus.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}status'],
        )!,
...
class RecurringTransactionRow extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['status'] = Variable<String>(
        $RecurringTransactionsTable.$converterstatus.toSql(status),
      );
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
...
class RecurringTransactionsCompanion
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (status.present) {
      map['status'] = Variable<String>(
        $RecurringTransactionsTable.$converterstatus.toSql(status.value),
      );
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
...
class $$BudgetsTableTableManager
    extends
        RootTableManager<
          ...
          BudgetRow,
          PrefetchHooks Function({bool categoryId, bool budgetCategoriesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({categoryId = false, budgetCategoriesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (budgetCategoriesRefs) db.budgetCategories,
...
final class $$RecurringTransactionsTableReferences
  ...
  static $FinancialAccountsTable _accountIdTable(_$AppDatabase db) =>
      db.financialAccounts.createAlias(
        'recurring_transactions__account_id__financial_accounts__id',
      );
  ...
  static $FinancialAccountsTable _destinationAccountIdTable(
    ...
    'recurring_transactions__destination_account_id__financial_accounts__id',
  );
...
class $$RecurringTransactionsTableTableManager
    extends
        RootTableManager<
          ...
          (RecurringTransactionRow, $$RecurringTransactionsTableReferences),
          RecurringTransactionRow,
          PrefetchHooks Function({
            bool accountId,
            bool destinationAccountId,
