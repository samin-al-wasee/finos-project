...
- **dashboard** — Financial overview with balances, this-month spending by category, and recent activity (FR-07). Budget status on the dashboard is still deferred until a dedicated analytics pass; the Budgets tab covers budget status for now.
